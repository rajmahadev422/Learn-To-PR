...
- GitHub releases: [github](https://github.com/opencv/opencv/releases)
- SourceForge.net: [sourceforge](https://sourceforge.net/projects/opencvlibrary/files/)

## Third-party packages

Other organizations and people maintain their own binary distributions of OpenCV. For example:

- System packages in popular Linux distributions [linux](https://pkgs.org/search/?q=opencv)
...
- Go to [opencv-source-code](https://github.com/opencv/opencv/releases) and download "Source code" archive from any release.
- (optionally) Go to [opencv_contrib-source0code](https://github.com/opencv/opencv_contrib/releases) and download "Source code" archive for the same release as _opencv_
- (optionally) Go to [opencv_extra-source-code](https://github.com/opencv/opencv_extra/releases) and download "Source code" archive for the same release as _opencv_
...
> `cmake-gui` application allows to see and modify available options using graphical user interface. See [cmake](https://cmake.org/runningcmake/) for details.
